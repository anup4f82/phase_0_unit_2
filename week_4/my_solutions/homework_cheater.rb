...
Essay1 = "Essay1: George Walker Bush is the 43rd President of USA.He was born on July 6, 1946 in New Haven, Connecticut on July 6, 1946.He manages Government effectively.His duties are:Making treaties with other countries,Commanding the US armed forces,making sure that the US laws are enforced"
Essay2 = "Essay2: Barack Obama is the 44th President of USA.He was born on August 4, 1961 in Honolulu,Hawaii on August 4, 1961.He manages Government effectively.His duties are:Making treaties with other countries,Commanding the US armed forces,making sure that the US laws are enforced"
Essay3 = "Essay3: Hillary Clinton is the 45th President of USA.She was born on October 26, 1947 in Chicago, Illinois on October 26, 1947.She manages Government effectively.Her duties are:Making treaties with other countries,Commanding the US armed forces,making sure that the US laws are enforced"

# Check if output is String

p essay_writer("Essay1","George Walker Bush","July 6, 1946","Making treaties with other countries,Commanding the US armed forces,making sure that the US laws are enforced","male","New Haven, Connecticut","43rd").class == String

p essay_writer("Essay2","Barack Obama","August 4, 1961","Making treaties with other countries,Commanding the US armed forces,making sure that the US laws are enforced","male","Honolulu,Hawaii","44th").class == String


p essay_writer("Essay3","Hillary Clinton","October 26, 1947","Making treaties with other countries,Commanding the US armed forces,making sure that the US laws are enforced","female","Chicago, Illinois","45th").class == String

# Check if output equals variables declared
 
 p essay_writer("Essay1","George Walker Bush","July 6, 1946","Making treaties with other countries,Commanding the US armed forces,making sure that the US laws are enforced","male","New Haven, Connecticut","43rd") == Essay1
 
 p essay_writer("Essay2","Barack Obama","August 4, 1961","Making treaties with other countries,Commanding the US armed forces,making sure that the US laws are enforced","male","Honolulu,Hawaii","44th")== Essay2
 
 p essay_writer("Essay3","Hillary Clinton","October 26, 1947","Making treaties with other countries,Commanding the US armed forces,making sure that the US laws are enforced","female","Chicago, Illinois","45th") == Essay3
...
# I used gsub! a lot to do my substitutions . Not sure if that was expected. 
...
# Driver test code and if I have done what was expected!
# 
# 
# 